// Removido o useNavigate do react-router-dom
export default function ContaConfirmada({ onIrParaLogin }) {
  
  function irParaLogin() {
    // limpa o "?confirmado=1" da URL para não recarregar preso na mesma tela
    window.history.replaceState({}, '', window.location.pathname)
    // executa o callback que desativa o estado 'confirmado' e exibe o login
    onIrParaLogin()
  }
